...
export type ApplicantStatus = 'applied' | 'shortlisted' | 'test_task' | 'responded' | 'feedback' | 'offer' | 'hired' | 'rejected';

// The stage an applicant was in when they were rejected (excludes 'rejected' and 'hired')
export type RejectionStage = 'applied' | 'shortlisted' | 'test_task' | 'responded' | 'feedback' | 'offer';
