...
function convertToApplicant(id: string, data: any): Applicant {
  return {
    ...
    aiScore: data.aiScore ? {
      total: data.aiScore.total,
      dimensions: data.aiScore.dimensions,
      tier: data.aiScore.tier,
      reasoning: data.aiScore.reasoning,
      redFlags: data.aiScore.redFlags || [],
      strengths: data.aiScore.strengths || [],
      overQualified: data.aiScore.overQualified || false,
      instantReject: data.aiScore.instantReject || false,
      scoredAt: safeToDate(data.aiScore.scoredAt) || new Date(),
    } : null,
    notes: data.notes || '',
